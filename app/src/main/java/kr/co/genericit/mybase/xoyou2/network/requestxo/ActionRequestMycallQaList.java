...
import kr.co.genericit.mybase.xoyou2.network.modelxo.ReqMycallQaList;
...
public class ActionRequestMycallQaList extends Action {

    public ActionResultListener mActionResultInterface;
    public String mUserId;

    public ActionRequestMycallQaList(Activity context, String userId, ActionResultListener actionResultInterface) {
...
//            actionDone("", null, "");
    ...
    public void run() {
        ...
        int keywordCount = 0;
        ReqMycallQaList data = new ReqMycallQaList();
        if(mUserId != null) data.setUserId(mUserId);

        mRetrofitAPIService.requestMycallQaList(data).enqueue(mCallback);
    }
}
