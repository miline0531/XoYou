...
public class FindFragment extends Fragment {
    ...
    private void initView(View v) {
        ...
        layout_viewpager = v.findViewById(R.id.layout_viewpager);
...
//        setViewPager();
    ...
    public void setViewPager(){
        ...
        fragments = new int[]{R.layout.fragment_find_un,
                R.layout.fragment_find_graph};
    ...
    public class ViewsSliderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if(position == 0 ){
                ...
                txt_date2 = mainTopView.get(1).findViewById(R.id.txt_date);
                txt_info2 = mainTopView.get(1).findViewById(R.id.txt_info);
                chart_radar = mainTopView.get(1).findViewById(R.id.chart_radar);
