package kr.co.genericit.mybase.xoyou2.graph;
...
public class CircleProgress extends View {
    ...
    private Paint mPrimaryPaintBlack;
    ...
    private int mPrimaryProgressColorBlack;
    ...
    void init(Context context, AttributeSet attrs) {
        ...
        try {
            mDrawText = a.getBoolean(R.styleable.circleProgress_showProgressText, false);

            mBackgroundColor = a.getColor(R.styleable.circleProgress_backgroundColor, android.R.color.darker_gray);
            mPrimaryProgressColor = a.getColor(R.styleable.circleProgress_progressColor, android.R.color.darker_gray);
            mSecondaryProgressColor = a.getColor(R.styleable.circleProgress_secondaryProgressColor, android.R.color.black);
            mPrimaryProgressColorBlack = a.getColor(R.styleable.circleProgress_progressColor, android.R.color.black);

            mProgress = a.getInt(R.styleable.circleProgress_circle_progress, 0);
            mSecodaryProgress = a.getInt(R.styleable.circleProgress_secondaryProgress, 0);

            mStrokeWidth = a.getDimensionPixelSize(R.styleable.circleProgress_strokeWidth, 20);
            mTextColor = a.getColor(R.styleable.circleProgress_textColor, android.R.color.black);

            mPrimaryCapSize = a.getInt(R.styleable.circleProgress_primaryCapSize, 20);
            mSecondaryCapSize = a.getInt(R.styleable.circleProgress_secodaryCapSize, 20);

            mIsPrimaryCapVisible = a.getBoolean(R.styleable.circleProgress_primaryCapVisibility, true);
            mIsSecondaryCapVisible = a.getBoolean(R.styleable.circleProgress_secodaryCapVisibility, true);
        } finally {
            a.recycle();
        }
        ...
        mPrimaryPaintBlack = new Paint();
        mPrimaryPaintBlack.setAntiAlias(true);
        mPrimaryPaintBlack.setStyle(Paint.Style.STROKE);
        mPrimaryPaintBlack.setStrokeWidth(mStrokeWidth);
        mPrimaryPaintBlack.setColor(R.color.black);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPrimaryPaintBlack.setStyle(Paint.Style.FILL);
        mPrimaryPaintBlack.setAlpha(255);
//        if (mIsPrimaryCapVisible)
//            canvas.drawCircle(x + (mWidth / 2), y + (mHeight / 2), mPrimaryCapSize, mPrimaryPaintBlack);
