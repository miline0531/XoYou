 ...
 * 회원가입 Request
 */
public class ActionRequestSignUp2 extends Action {

    public ActionResultListener mActionResultInterface;
    private SignUpInfo mData;

    public ActionRequestSignUp2(Activity context, SignUpInfo data, ActionResultListener actionResultInterface) {
    ...
    public void run() {
        ...
        mRetrofitAPIService.requestSignUp2(signUpInfo).enqueue(mCallback);
    }
}
