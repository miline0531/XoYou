...
import kr.co.genericit.mybase.xoyou2.network.modelxo.ReqXoYouMeetNameList;
...
public class ActionRequestXoYouMeetNameList extends Action {

    public ActionResultListener mActionResultInterface;
    public String mUserId,mDate;

    public ActionRequestXoYouMeetNameList(Activity context, String userId, String date, ActionResultListener actionResultInterface) {
...
//            actionDone("", null, "");
    ...
    public void run() {
        ...
        int keywordCount = 0;
        ReqXoYouMeetNameList data = new ReqXoYouMeetNameList();
        if(mUserId != null) data.setUserId(mUserId);

        mRetrofitAPIService.requestXoYouMeetNameList(data).enqueue(mCallback);
    }
}
