...
public class ProgressCircle extends View {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mColor1 = attributes.getColor(R.styleable.SeekCircle_startColor, Color.parseColor("#CCFF3F7B"));
            mColor2 = attributes.getColor(R.styleable.SeekCircle_endColor, Color.parseColor("#CCFF3F7B"));
            mInactiveColor = attributes.getColor(R.styleable.SeekCircle_inactiveColor, Color.parseColor("#cccdcdcd"));
    ...
    public void setProgressColor(int startColor){
        mColor1 = startColor;
        mColor2 = startColor;
    }
