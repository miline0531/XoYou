...
import com.redrover.xoyou.network.modelxo.ReqXoYouUserLoad;
...
public class ActionRequestXoYouUserLoad extends Action {

    public ActionResultListener mActionResultInterface;
    public String mUserId;

    public ActionRequestXoYouUserLoad(Activity context, String userId, ActionResultListener actionResultInterface) {
...
//            actionDone("", null, "");
    ...
    public void run() {
        ...
        int keywordCount = 0;
        ReqXoYouUserLoad data = new ReqXoYouUserLoad();
        if(mUserId != null) data.setUserId(mUserId);

        mRetrofitAPIService.requestXoYouUserLoad(data).enqueue(mCallback);
    }
}
