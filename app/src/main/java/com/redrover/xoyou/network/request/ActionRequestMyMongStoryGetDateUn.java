...
public class ActionRequestMyMongStoryGetDateUn extends Action {

    public ActionResultListener mActionResultInterface;
    public String sDate,eDate;

    public ActionRequestMyMongStoryGetDateUn(Activity context, String sDate, String eDate, ActionResultListener actionResultInterface) {
...
//            actionDone("", null, "");
    ...
    public void run() {
        ...
        MongStoryDateChart data = new MongStoryDateChart();
        ...
        mRetrofitAPIService.ActionRequestMyMongStoryGetDateUn(data).enqueue(mCallback);
