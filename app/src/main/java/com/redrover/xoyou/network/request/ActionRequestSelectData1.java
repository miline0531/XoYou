...
public class ActionRequestSelectData1 extends Action {

    public ActionResultListener mActionResultInterface;

    public ActionRequestSelectData1(Activity context, ActionResultListener actionResultInterface) {
...
//        Log.v("CHECK","DDDDD :: " + addUserInfo.getUs().toString() );
       ...
       // us =addUserInfo.US(userId,5,nickName,name,gender,birth,"");
        mRetrofitAPIService.requestKeywordSelectData().enqueue(mCallback);
    }
}
