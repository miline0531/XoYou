...
public class ActionRequestStoreMongStoryGetLocationColor extends Action {

    public ActionResultListener mActionResultInterface;
    private String mLat,mLng,mCheung;

    public ActionRequestStoreMongStoryGetLocationColor(Activity context, String mLat,String mLng,String mCheung, ActionResultListener actionResultInterface) {
        mBaseActivity = context;
        mBaseContext = context;
        this.mLat = mLat;
        this.mLng = mLng;
        this.mCheung = mCheung;
...
//            actionDone("", null, "");
    ...
    public void run() {
        ...
        LocationColorInfo info = new LocationColorInfo();
        info.setUserId(userId);
        info.setLat(mLat);
        info.setLng(mLng);
        info.setCheung(mCheung);

        mRetrofitAPIService.requestLocationColor(info).enqueue(mCallback);
    }
}
